    ...
    <div id="contents_wrap">
        <div id="container">
            <div id="contents">
                ...
                <style>.mCafe24Post.gPc.typeLayer {margin:0!important; left:0px!important;}</style>
...
$foreignerSsn3 = 국제운전면허증번호
 -->
                    <div class="ec-base-table typeWrite" style="display:none;">
                        <table border="1" summary="">
                            ...
                            <tr class="displaynone">
                                ...
                                <td><input id="member_type0" name="member_type" fw-filter="isFill" fw-label="회원구분" fw-msg="" value="p" type="radio" checked="checked" autocomplete="off"><label for="member_type0">개인회원</label>
                                    <input id="member_type1" name="member_type" fw-filter="isFill" fw-label="회원구분" fw-msg="" value="c" type="radio" autocomplete="off"><label for="member_type1">사업자회원</label>
                                    <input id="member_type2" name="member_type" fw-filter="isFill" fw-label="회원구분" fw-msg="" value="f" type="radio" autocomplete="off"><label for="member_type2">외국인회원(foreigner)</label></td>
                            </tr>
                            <tr id="companyWrap" style="display: none;">
                                <th scope="row">사업자구분 <img src="https://img.echosting.cafe24.com/skin/base/common/ico_required.gif" alt="필수"></th>
                                <td></td>
                            </tr>
                            <tr id="authMember" style="display: none;">
                                ...
                                <td>
                                    <div id="authWrap" style="display:none;">
                                        <!-- 개인 회원 인증 -->
                                        <div id="personAuth" style="">
                                            <div id="personalTypeWrap" style=""></div>
                                            <!-- 아이핀인증 -->
                                            <div id="ipinWrap" style="display: none;"></div>
                                            <!-- 휴대폰인증 -->
                                            <div id="mobileWrap" style="display: none;"></div>
                                            <!-- 이메일인증 -->
                                            <div id="emailWrap" style=""></div>
                                        </div>

                                        <!-- 법인 사업자 인증 -->
                                        <div id="businessAuth" style="display: none;">
                                            <ul class="grid">
                                                <li>법인명<br></li>
                                                <li>법인번호<br> -  <a href="#none" onclick="CompanyCheck.checkDupl(); return false;"><img src="https://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_check2.gif" alt="중복확인"></a>
                                                </li>
                                            </ul>
                                        </div>

                                        <!-- 외국인 회원 인증 -->
                                        <div id="foreignerAuth" style="display: none;">
                                            <ul class="grid">
                                                ...
                                                <li> <input id="foreigner_ssn" name="foreigner_ssn" fw-filter="" fw-label="foreigner_ssn" fw-msg="" class="inputTypeText" placeholder="" value="" type="text"> <a href="#none" onclick="checkForeignerNumber();"><img src="https://img.echosting.cafe24.com/skin/base_ko_KR/member/btn_check2.gif" alt="중복확인"></a>
                                                </li>
                                            </ul>
                                            <div id="foreignerPersonWrap" style="display: none;">
                                            ...
                                            <!-- 이메일인증 -->
                                            <div id="foreignerEmailWrap" style="display: none;">
                                                <ul>
                    ...
                    <div class="ec-base-table typeWrite ">
                        <table border="1" summary="">
                            ...
                            <tr>
                                <th scope="row">ID </th>
                                <td><input id="member_id" name="member_id" fw-filter="isFill&amp;isFill&amp;isMin[4]&amp;isMax[16]&amp;isIdentity" fw-label="아이디" fw-msg="" class="inputTypeText" placeholder="" value="" type="text">
                                    <p class="text_guide"><span id="idMsg"></span> 영문 소문자/숫자, 4-16자</p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">PASSWORD</th>
                                <td><input id="passwd" name="passwd" fw-filter="isFill&amp;isMin[4]&amp;isMax[16]" fw-label="비밀번호" fw-msg="" autocomplete="off" maxlength="16" 0="disabled" value="" type="password">
                                    <p class="text_guide">(영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr class="displaynone">
                                <th scope="row">P/W HINT ANSWER</th>
                            ...
                            <tr class="displaynone">
                                <th scope="row">NAME(영문) <img src="https://img.echosting.cafe24.com/skin/base/common/ico_required.gif" class="displaynone" alt="필수"></th>
                            ...
                            <!-- 외국인 회원 정보 --><tr style="display: none;">
                                <th scope="row" id="ssnTitle"></th>
                                <td id="ssnContents"></td>
                            </tr>
                            <!-- //외국인 회원 정보 --><tr id="companyRow" style="display: none;">
                                <th scope="row">상호명 </th>
                            ...
                            <tr class="displaynone">
                                <th scope="row">ADDRESS <img src="https://img.echosting.cafe24.com/skin/base/common/ico_required.gif" class="displaynone" alt="필수"></th>
                                <td>
                                    <input id="postcode1" name="postcode1" fw-filter="isLengthRange[1][14]" fw-label="우편번호1" fw-msg="" class="inputTypeText" placeholder="" readonly="readonly" maxlength="14" value="" type="text"><a href="#none" onclick="" class="btn_000" id="postBtn">ZIP-CODE</a><br>
                                    <input id="addr1" name="addr1" fw-filter="" fw-label="주소" fw-msg="" class="inputTypeText" placeholder="" readonly="readonly" value="" type="text"><br>
                                    <input id="addr2" name="addr2" fw-filter="" fw-label="주소" fw-msg="" class="inputTypeText" placeholder="" value="" type="text"> </td>
                            </tr>
                            <tr class="displaynone">
...
<input id="is_solar_calendar1" name="is_solar_calendar" fw-filter="" fw-label="생년월일" fw-msg="" value="F" type="radio" autocomplete="off"><label for="is_solar_calendar1">음력</label></span>
                    ...
                    <div class="text-button-center">
                        <a href="#none" onclick="memberJoinAction()" class="btn_1000">SUBMIT</a>
                    </div>
                    <!-- 회원 가입 정보 확인 레이어 -->
                    <div id="ec_shop_member_confirm-infolayer" class="joinConfirm ec-base-layer ">
                        ...
                        <div class="content">
                            ...
                            <div class="ec-base-table">
                                <table border="1" summary="">
                                    ...
                                    <!-- //외국인 회원 정보 --><tr id="ec_shop_member_confirm-company_name">
                                        <th scope="row">상호명</th>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr class="displaynone">
                                        <th scope="row">주소</th>
                                        <td>
                                            <span id="ec_shop_member_confirm_field-postcode1"></span><br><span id="ec_shop_member_confirm_field-addr1"></span>
                                            <span id="ec_shop_member_confirm_field-addr2"></span>
                                        </td>
                                    </tr>
                                    <tr class="displaynone">
                                    ...
                                    <tr>
                                        <th scope="row">이메일</th>
                                        <td>
                                            <span id="ec_shop_member_confirm_field-email1"></span>@<span id="ec_shop_member_confirm_field-email2"></span>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <th scope="row">이메일 수신여부</th>
                                        <td><span id="ec_shop_member_confirm_field-is_news_mail"></span></td>
                                    </tr>
                                    <tr class="displaynone">
                                        <th scope="row">별명</th>
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <span id="ec_shop_member_confirm_field-birth_year"></span><span>/</span><span id="ec_shop_member_confirm_field-birth_month"></span><span>/</span><span id="ec_shop_member_confirm_field-birth_day"></span> <span class="">(<span id="ec_shop_member_confirm_field-is_solar_calendar"></span>)</span>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <th scope="row">결혼기념일</th>
                                        <td>
                                            <span id="ec_shop_member_confirm_field-marry_year"></span><span>/</span><span id="ec_shop_member_confirm_field-marry_month"></span><span>/</span><span id="ec_shop_member_confirm_field-marry_day"></span>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        <th scope="row">배우자생일</th>
                                        <td>
                                            <span id="ec_shop_member_confirm_field-partner_year"></span><span>/</span><span id="ec_shop_member_confirm_field-partner_month"></span><span>/</span><span id="ec_shop_member_confirm_field-partner_day"></span>
                                        </td>
                                    </tr>
                                    <tr class="displaynone">
                                        <th scope="row">자녀</th>
                                    ...
                                    <tr class="displaynone">
                                        ...
                                        <td>
                                            <ul class="account">
                                                <li>
                                                    예금주 : <span id="ec_shop_member_confirm_field-bank_account_owner"></span>
                                                </li>
                                                <li>
                                                    은행명 : <span id="ec_shop_member_confirm_field-refund_bank_code"></span>
                                                </li>
                                                <li>
                                                    계좌번호 : <span id="ec_shop_member_confirm_field-bank_account_no"></span>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                        ...
                        <div class="ec-base-button">
                            <a href="#none"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/member/btn_member_join2.gif" alt="회원가입" id="ec_shop_confirm-checkingjoininfo_action"></a>
                            <a href="#none"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/common/btn_layer_close.gif" alt="닫기" onclick="CheckingJoinInfoLayerClose()"></a>
                        </div>
