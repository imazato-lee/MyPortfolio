    ...
    <div id="contents_wrap">
        <div id="container">
            <div id="contents">
                ...
                <div class="titleArea">
                    <h2>${mode eq 'modify' ? 'MODIFY' : 'REGISTER'}</h2>
                </div>
                ${mode eq 'modify' ? '' : '<button id="id-check">중복 확인</button>'}
                    <c:choose>
                        <c:when test="${mode eq 'modify'}">
                    <form id="registerForm" method="POST" action="<c:url value='/user/modify' />">
                        </c:when>
                        <c:otherwise>
                        ...
                        <div class="ec-base-table typeWrite ">
                            <table border="1" summary="">
                                ...
                                <tr>
                                    ...
                                    <td><input id="pwdInput" name="pwd" autocomplete="off" minlength="6" maxlength="20" 0="disabled" placeholder="비밀번호 입력(문자,숫자,특수문자 포함 8~20자)"value="" type="password">
                                        <p class="text_guide"><span id="pwMsg"></span></p>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">PASSWORD CHECK</th>
                                    <td><input id="pwdCheckInput" name="pwdCheckInput" autocomplete="off"minlength="6" maxlength="20" placeholder="비밀번호 재입력" 0="disabled" value="" type="password">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="email" id="email-txt" type="text" placeholder="이메일 입력"/>
                                        <span style="color: rgb(119, 119, 119);">@</span>
                                        <input class="email" id="domain-txt" type="text"/>
                                        <select class="email" id="domain-list">
                                            <option value="type">직접입력</option>
                                            <option value="gmail.com">gmail.com</option>
                                            <option value="naver.com">naver.com</option>
                                            <option value="icloud.com">icloud.com</option>
                                        </select>
                                        <p class="text_guide"><span id="emailMsg"></span></p>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input id="year" name="year" placeholder="년(4자)" value="" type="text">
                                        ...
                                        <input id="day" name="day" placeholder="일" value="" type="text">
                                        <p class="text_guide"><span id="birthMsg"></span></p>
                                    </td>
                                </tr>
                                <tr class="">
                                    <th scope="row">MOBILE
                                    ...
                                    <td><input id="mobile" name="mobile" placeholder="휴대폰 번호 입력('-' 제외 11자리 입력)" value="${userDto.mobile}" type="text" style="width:255px">
                                        <p class="text_guide"><span id="mobilelMsg"></span></p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="agreeArea_wrap" ${ mode eq 'modify' ? 'style="display: none"' : ''} >
                            <ul class="left">
                                <div class="agreeArea">
                                    <div class="agree">
