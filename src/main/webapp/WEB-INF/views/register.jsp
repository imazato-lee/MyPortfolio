                    ...
                    <div class="xans-element- xans-member xans-member-join">
                        <div class="ec-base-table typeWrite ">
                            <table border="1" summary="">
                                ...
                                <tr>
                                    <th scope="row">ID
                                        <img src="<c:url value='/images/ico_required.gif'/>" alt="필수"/>
                                    </th>
                                    <td><input id="idInput" name="id" placeholder="아이디를 입력하세요(6~20자)" value="" type="text" >
                                ...
                                <tr>
                                    ...
                                    <td><input id="nameInput" name="name" placeholder="이름을 입력해주세요" value="" type="text">
                                ...
                                <tr class="">
                                    ...
                                    <td><input id="mobile" name="mobile" placeholder="휴대폰 번호 입력('-' 제외 11자리 입력)" value="" type="text" style="width:255px">
                        ...
                        <div class="agreeArea_wrap">
                            <ul class="left">
                                <div class="agreeArea">
                                    ...
                                    <p class="check"><span>이용약관에 동의하십니까?</span> <input id="agree_service_check" name="agree_service_check" type="checkbox"><label>동의함</label></p>
                                </div>
                            </ul>
                            <ul class="right">
                                <div class="agreeArea">
                                    ...
                                    <p class="check"><span>개인정보 수집 및 이용에 동의하십니까?</span> <input id="agree_privacy_check" name="agree_privacy_check"class="ec-base-chk" type="checkbox"><label>동의함</label></p>
                                </div>
                            </ul>
                        </div>
